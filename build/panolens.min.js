...
onClick:function(a){if(this.element&&this.getContainer()){for(var b=this.getContainer().getElementsByClassName("panolens-infospot"),c=0;c<b.length;c++)b[c].style.display="none";this.onHoverStart(a);if((b=this.element)&&0<=a.mouseEvent.clientX&&0<=a.mouseEvent.clientY){a=b.left;c=b.right;var d=b.style;this.mode===t.CARDBOARD||this.mode===t.STEREO?(d.display="none",a.style.display="block",c.style.display="block",b._width=a.clientWidth,b._height=a.clientHeight):(d.display="block",a&&(a.style.display=
"none"),c&&(c.style.display="none"),b._width=b.clientWidth,b._height=b.clientHeight)}this.lockHoverElement()}},onDismiss:function(){this.element&&(this.unlockHoverElement(),this.onHoverEnd())},onHover:function(){},onHoverStart:function(){if(this.getContainer()){var a=this.cursorStyle||(this.mode===t.NORMAL?"pointer":"default"),b=this.scaleDownAnimation,c=this.scaleUpAnimation;this.isHovering=!0;this.container.style.cursor=a;this.animated&&(b.stop(),c.start())}},onHoverEnd:function(){if(this.getContainer()){var a=
...
a.right=a.cloneNode(!0)),this.mode===t.CARDBOARD||this.mode===t.STEREO?(a.left.style.display=a.style.display,a.right.style.display=a.style.display,a.style.display="none"):(a.style.display=a.left.style.display,a.left.style.display="none",a.right.style.display="none"),this.translateElement(b,c),this.container.appendChild(a.left),this.container.appendChild(a.right))}},translateElement:function(a,b){if(this.element._width&&this.element._height&&this.getContainer()){var c=this.container;var d=this.element;
var e=d._width/2;var g=d._height/2;var p=void 0!==d.verticalDelta?d.verticalDelta:40;var m=a-e;var k=b-g-p;this.mode!==t.CARDBOARD&&this.mode!==t.STEREO||!d.left||!d.right||a===c.clientWidth/2&&b===c.clientHeight/2?this.setElementStyle("transform",d,"translate("+m+"px, "+k+"px)"):(m=c.clientWidth/4-e+(a-c.clientWidth/2),k=c.clientHeight/2-g-p+(b-c.clientHeight/2),this.setElementStyle("transform",d.left,"translate("+m+"px, "+k+"px)"),m+=c.clientWidth/2,this.setElementStyle("transform",d.right,"translate("+
m+"px, "+k+"px)"))}},setElementStyle:function(a,b,c){b=b.style;"transform"===a&&(b.webkitTransform=b.msTransform=b.transform=c)},setText:function(a){this.element&&(this.element.textContent=a)},setCursorHoverStyle:function(a){this.cursorStyle=a},addHoverText:function(a,b){b=void 0===b?40:b;this.element||(this.element=document.createElement("div"),this.element.style.display="none",this.element.style.color="#fff",this.element.style.top=0,this.element.style.maxWidth="50%",this.element.style.maxHeight=
...
"touchend":"click",function(b){b.preventDefault();b.stopPropagation();a.mask.hide();a.settingElement.deactivate()},!1);this.addEventListener("control-bar-toggle",d.toggle);this.barElement=d}else console.warn("Widget container not set")},createDefaultMenu:function(){var a=this;var b=function(b,d){return function(){a.dispatchEvent({type:"panolens-viewer-handler",method:b,data:d})}};return[{title:"Control",subMenu:[{title:this.TOUCH_ENABLED?"Touch":"Mouse",handler:b("enableControl",E.ORBIT)},{title:"Sensor",
handler:b("enableControl",E.DEVICEORIENTATION)}]},{title:"Mode",subMenu:[{title:"Normal",handler:b("disableEffect")},{title:"Cardboard",handler:b("enableEffect",t.CARDBOARD)},{title:"Stereoscopic",handler:b("enableEffect",t.STEREO)}]}]},addControlButton:function(a){switch(a){case "fullscreen":this.fullscreenElement=a=this.createFullscreenButton();break;case "setting":this.settingElement=a=this.createSettingButton();break;case "video":this.videoElement=a=this.createVideoControl();break;default:return}a&&
this.barElement.appendChild(a)},createMask:function(){var a=document.createElement("div");a.style.position="absolute";a.style.top=0;a.style.left=0;a.style.width="100%";a.style.height="100%";a.style.background="transparent";a.style.display="none";a.show=function(){this.style.display="block"};a.hide=function(){this.style.display="none"};return a},createSettingButton:function(){var a=this;var b=this.createCustomItem({style:{backgroundImage:'url("'+u.Setting+'")',webkitTransition:this.DEFAULT_TRANSITION,
