...
(b.stop(),c.delay(a).start()):(this.enableRaycast(!0),d.opacity=1)},hide:function(a){a=void 0===a?0:a;var b=this.animated,c=this.hideAnimation,d=this.showAnimation,g=this.material,e=this.element;e&&(e.style.display="none");b?(d.stop(),c.delay(a).start()):(this.enableRaycast(!1),g.opacity=0)},setFocusMethod:function(a){a&&(this.HANDLER_FOCUS=a.method)},focus:function(a,b){this.HANDLER_FOCUS&&(this.HANDLER_FOCUS(this.position,a,b),this.onDismiss())},dispose:function(){var a=this.geometry,b=this.material,
...
createFullscreenButton:function(){function a(){d&&(c=!c,e.style.backgroundImage=c?'url("'+u.FullscreenLeave+'")':'url("'+u.FullscreenEnter+'")');b.dispatchEvent({type:"panolens-viewer-handler",method:"onWindowResize"});d=!0}var b=this,c=!1,d=!0,g=this.container;if(document.fullscreenEnabled||document.webkitFullscreenEnabled||document.mozFullScreenEnabled||document.msFullscreenEnabled){document.addEventListener("fullscreenchange",a,!1);document.addEventListener("webkitfullscreenchange",a,!1);document.addEventListener("mozfullscreenchange",
a,!1);document.addEventListener("MSFullscreenChange",a,!1);var e=this.createCustomItem({style:{backgroundImage:'url("'+u.FullscreenEnter+'")'},onTap:function(a){a.preventDefault();a.stopPropagation();d=!1;c?(document.exitFullscreen&&document.exitFullscreen(),document.msExitFullscreen&&document.msExitFullscreen(),document.mozCancelFullScreen&&document.mozCancelFullScreen(),document.webkitExitFullscreen&&document.webkitExitFullscreen(),c=!1):(g.requestFullscreen&&g.requestFullscreen(),g.msRequestFullscreen&&
g.msRequestFullscreen(),g.mozRequestFullScreen&&g.mozRequestFullScreen(),g.webkitRequestFullscreen&&g.webkitRequestFullscreen(Element.ALLOW_KEYBOARD_INPUT),c=!0);this.style.backgroundImage=c?'url("'+u.FullscreenLeave+'")':'url("'+u.FullscreenEnter+'")'}});if(!document.querySelector("panolens-style-addon")){var p=document.createElement("style");p.id="panolens-style-addon";p.innerHTML=":-webkit-full-screen { width: 100% !important; height: 100% !important }";document.body.appendChild(p)}return e}},
...
a?a:this.paused;this.style.backgroundImage='url("'+(this.paused?u.VideoPlay:u.VideoPause)+'")'};return b},createVideoControlSeekbar:function(){function a(a){a.stopPropagation();e=!0;p=a.clientX||a.changedTouches&&a.changedTouches[0].clientX;m=parseInt(h.style.width)/100;g.container.addEventListener("mousemove",b,{passive:!0});g.container.addEventListener("mouseup",c,{passive:!0});g.container.addEventListener("touchmove",b,{passive:!0});g.container.addEventListener("touchend",c,{passive:!0})}function b(a){e&&
(l=((a.clientX||a.changedTouches&&a.changedTouches[0].clientX)-p)/f.clientWidth,l=m+l,l=1<l?1:0>l?0:l,f.setProgress(l),g.dispatchEvent({type:"panolens-viewer-handler",method:"setVideoCurrentTime",data:l}))}function c(a){a.stopPropagation();e=!1;d()}function d(){g.container.removeEventListener("mousemove",b,!1);g.container.removeEventListener("mouseup",c,!1);g.container.removeEventListener("touchmove",b,!1);g.container.removeEventListener("touchend",c,!1)}var g=this,e=!1,p,m,l;var h=document.createElement("div");
...
onTap:function(a){a.preventDefault();a.stopPropagation();if(a.target!==q){var b=a.changedTouches&&0<a.changedTouches.length?(a.changedTouches[0].pageX-a.target.getBoundingClientRect().left)/this.clientWidth:a.offsetX/this.clientWidth;g.dispatchEvent({type:"panolens-viewer-handler",method:"setVideoCurrentTime",data:b});f.setProgress(a.offsetX/this.clientWidth)}},onDispose:function(){d();q=h=null}});f.appendChild(h);f.setProgress=function(a){h.style.width=100*a+"%"};this.addEventListener("video-update",
...
k.style.paddingLeft="20px";k.addIcon().addEventListener(c.TOUCH_ENABLED?"touchend":"click",b,!1);a[e].subMenu&&0<a[e].subMenu.length&&k.addSelection(a[e].subMenu[0].title).addSubMenu(a[e].title,a[e].subMenu)}return d},createSubMenu:function(a,b){function c(a){a.preventDefault();a.stopPropagation();e=d.mainMenu;e.changeSize(e._width);e.unslideAll();e.show();k.slideAll(!0);k.hide();"header"!==this.type&&(k.setActiveItem(this),d.activeMainItem.setSelectionTitle(this.textContent),this.handler&&this.handler())}
var d=this,e,k=this.createMenu();k.items=b;k.activeItem=null;k.addHeader(a).addIcon(void 0,!0,!0).addEventListener(d.TOUCH_ENABLED?"touchend":"click",c,!1);for(a=0;a<b.length;a++){var h=k.addItem(b[a].title);h.style.fontWeight=300;h.handler=b[a].handler;h.addIcon(" ",!0);h.addEventListener(d.TOUCH_ENABLED?"touchend":"click",c,!1);k.activeItem||k.setActiveItem(h)}k.slideAll(!0);return k},createMenu:function(){var a=this,b=document.createElement("span"),c=b.style;c.padding="5px 0";c.position="fixed";
