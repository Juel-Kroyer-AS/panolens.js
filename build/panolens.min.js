...
void 0===a?16777215:a;b=void 0===b?!0:b;c=void 0===c?1500:c;this.dpr=window.devicePixelRatio;var d=this.createCanvas(),l=d.canvas;d=d.context;var g=new e.SpriteMaterial({color:a,map:this.createCanvasTexture(l)});e.Sprite.call(this,g);this.canvasWidth=l.width;this.canvasHeight=l.height;this.context=d;this.color=a instanceof e.Color?a:new e.Color(a);this.autoSelect=b;this.dwellTime=c;this.rippleDuration=500;this.position.z=-10;this.center.set(.5,.5);this.scale.set(.5,.5,1);this.callback=this.timerId=
...
n.set(a.clientX,a.clientY)}x!==w.NONE&&(document.addEventListener("mousemove",d,!1),document.addEventListener("mouseup",l,!1),f.dispatchEvent(O));f.update()}}function d(a){if(!1!==f.enabled){a.preventDefault();var d=f.domElement===document?f.domElement.body:f.domElement;if(x===w.ROTATE){if(!0===f.noRotate)return;h.set(a.clientX,a.clientY);r.subVectors(h,D);f.rotateLeft(2*Math.PI*r.x/d.clientWidth*f.rotateSpeed);f.rotateUp(2*Math.PI*r.y/d.clientHeight*f.rotateSpeed);D.copy(h);G&&(K=a.clientX-G.clientX,
L=a.clientY-G.clientY);G=a}else if(x===w.DOLLY){if(!0===f.noZoom)return;z.set(a.clientX,a.clientY);T.subVectors(z,y);0<T.y?f.dollyIn():0>T.y&&f.dollyOut();y.copy(z)}else if(x===w.PAN){if(!0===f.noPan)return;U.set(a.clientX,a.clientY);t.subVectors(U,n);f.pan(t.x,t.y);n.copy(U)}x!==w.NONE&&f.update()}}function l(){Q=!0;G=void 0;!1!==f.enabled&&(document.removeEventListener("mousemove",d,!1),document.removeEventListener("mouseup",l,!1),f.dispatchEvent(P),x=w.NONE)}function g(a){if(!1!==f.enabled&&!0!==
...
!1;break;case f.keys.RIGHT:Y=!1}}function m(a){if(!1!==f.enabled&&!0!==f.noKeys&&!0!==f.noRotate){switch(a.keyCode){case f.keys.UP:I=!0;break;case f.keys.BOTTOM:J=!0;break;case f.keys.LEFT:X=!0;break;case f.keys.RIGHT:Y=!0}if(I||J||X||Y)Q=!0,I&&(L=-f.rotateSpeed*f.momentumKeydownFactor),J&&(L=f.rotateSpeed*f.momentumKeydownFactor),X&&(K=-f.rotateSpeed*f.momentumKeydownFactor),Y&&(K=f.rotateSpeed*f.momentumKeydownFactor)}}function k(a){Q=!1;K=L=0;if(!1!==f.enabled){switch(a.touches.length){case 1:if(!0===
...
this.getAzimuthalAngle=function(){return R};this.dispose=function(){this.domElement.removeEventListener("mousedown",c);this.domElement.removeEventListener("mousewheel",g);this.domElement.removeEventListener("DOMMouseScroll",g);this.domElement.removeEventListener("touchstart",k);this.domElement.removeEventListener("touchend",q);this.domElement.removeEventListener("touchmove",v);window.removeEventListener("keyup",p);window.removeEventListener("keydown",m)};this.domElement.addEventListener("mousedown",
...
this.camera=a;this.camera.rotation.reorder("YXZ");this.domElement=void 0!==b?b:document;this.enabled=!0;this.deviceOrientation={};this.alphaOffsetAngle=this.alpha=this.screenOrientation=0;var k=function(a){c.deviceOrientation=a},v=function(){c.screenOrientation=window.orientation||0},q=function(a){a.preventDefault();a.stopPropagation();p=a.touches[0].pageX;m=a.touches[0].pageY},f=function(a){a.preventDefault();a.stopPropagation();l+=e.Math.degToRad((a.touches[0].pageX-p)/4);g+=e.Math.degToRad((m-
a.touches[0].pageY)/4);c.updateAlphaOffsetAngle(l);p=a.touches[0].pageX;m=a.touches[0].pageY};this.connect=function(){v();window.addEventListener("orientationchange",v,{passive:!0});window.addEventListener("deviceorientation",k,{passive:!0});window.addEventListener("deviceorientation",this.update.bind(this),{passive:!0});c.domElement.addEventListener("touchstart",q,{passive:!1});c.domElement.addEventListener("touchmove",f,{passive:!1});c.enabled=!0};this.disconnect=function(){window.removeEventListener("orientationchange",
v,!1);window.removeEventListener("deviceorientation",k,!1);window.removeEventListener("deviceorientation",this.update.bind(this),!1);c.domElement.removeEventListener("touchstart",q,!1);c.domElement.removeEventListener("touchmove",f,!1);c.enabled=!1};this.update=function(a){if(!1!==c.enabled){var b=c.deviceOrientation.alpha?e.Math.degToRad(c.deviceOrientation.alpha)+c.alphaOffsetAngle:0,l=c.deviceOrientation.beta?e.Math.degToRad(c.deviceOrientation.beta):0,f=c.deviceOrientation.gamma?e.Math.degToRad(c.deviceOrientation.gamma):
0,p=c.screenOrientation?e.Math.degToRad(c.screenOrientation):0,m=c.camera.quaternion,k=new e.Vector3(0,0,1),D=new e.Euler,q=new e.Quaternion,v=new e.Quaternion(-Math.sqrt(.5),0,0,Math.sqrt(.5)),h=new e.Quaternion,r=new e.Quaternion;if(0==c.screenOrientation){var n=new e.Vector3(1,0,0);h.setFromAxisAngle(n,-g)}else 180==c.screenOrientation?(n=new e.Vector3(1,0,0),h.setFromAxisAngle(n,g)):90==c.screenOrientation?(n=new e.Vector3(0,1,0),h.setFromAxisAngle(n,g)):-90==c.screenOrientation&&(n=new e.Vector3(0,
1,0),h.setFromAxisAngle(n,-g));v.multiply(h);v.multiply(r);D.set(l,b,-f,"YXZ");m.setFromEuler(D);m.multiply(v);m.multiply(q.setFromAxisAngle(k,-p));c.alpha=b;!0!==a&&c.dispatchEvent(d)}};this.updateAlphaOffsetAngle=function(a){this.alphaOffsetAngle=a;this.update()};this.dispose=function(){this.disconnect()};this.connect()}function ha(a){var b=new e.OrthographicCamera(-1,1,1,-1,0,1),c=new e.Scene,d=new e.StereoCamera;d.aspect=.5;var l=new e.WebGLRenderTarget(512,512,{minFilter:e.LinearFilter,magFilter:e.NearestFilter,
format:e.RGBAFormat});l.scissorTest=!0;l.texture.generateMipmaps=!1;var g=new e.Vector2(.441,.156),p=(new e.PlaneBufferGeometry(1,1,10,20)).removeAttribute("normal").toNonIndexed(),m=p.attributes.position.array,k=p.attributes.uv.array;p.attributes.position.count*=2;p.attributes.uv.count*=2;var v=new Float32Array(2*m.length);v.set(m);v.set(m,m.length);var q=new Float32Array(2*k.length);q.set(k);q.set(k,k.length);k=new e.Vector2;m=m.length/3;for(var f=0,D=v.length/3;f<D;f++){k.x=v[3*f];k.y=v[3*f+1];
var h=k.dot(k);h=1.5+(g.x+g.y*h)*h;var n=f<m?0:1;v[3*f]=k.x/h*1.5-.5+n;v[3*f+1]=k.y/h*3;q[2*f]=.5*(q[2*f]+n)}p.attributes.position.array=v;p.attributes.uv.array=q;g=new e.MeshBasicMaterial({map:l.texture});p=new e.Mesh(p,g);c.add(p);this.setSize=function(d,b){a.setSize(d,b);var c=a.getPixelRatio();l.setSize(d*c,b*c)};this.render=function(g,f){g.updateMatrixWorld();null===f.parent&&f.updateMatrixWorld();d.update(f);f=l.width/2;var e=l.height;a.autoClear&&a.clear();l.scissor.set(0,0,f,e);l.viewport.set(0,
0,f,e);a.setRenderTarget(l);a.render(g,d.cameraL);a.clearDepth();l.scissor.set(f,0,f,e);l.viewport.set(f,0,f,e);a.setRenderTarget(l);a.render(g,d.cameraR);a.clearDepth();a.setRenderTarget(null);a.render(c,b)}}function da(a){a=a||{};a.controlBar=void 0!==a.controlBar?a.controlBar:!0;a.controlButtons=a.controlButtons||["fullscreen","setting","video"];a.autoHideControlBar=void 0!==a.autoHideControlBar?a.autoHideControlBar:!1;a.autoHideInfospot=void 0!==a.autoHideInfospot?a.autoHideInfospot:!0;a.horizontalView=
...
ea={load:function(a,b,c,d){b=void 0===b?function(){}:b;c=void 0===c?function(){}:c;d=void 0===d?function(){}:d;e.Cache.enabled=!0;var l,g,p,m;for(m in u)u.hasOwnProperty(m)&&a===u[m]&&(l=m);var k=e.Cache.get(l?l:a);if(void 0!==k)return b&&setTimeout(function(){c({loaded:1,total:1});b(k)},0),k;var h=window.URL||window.webkitURL;var q=document.createElementNS("http://www.w3.org/1999/xhtml","img");e.Cache.add(l?l:a,q);var f=function(){h.revokeObjectURL(q.src);b(q)};if(0===a.indexOf("data:"))return q.addEventListener("load",
f,!1),q.src=a,q;q.crossOrigin=void 0!==this.crossOrigin?this.crossOrigin:"";l=new window.XMLHttpRequest;l.open("GET",a,!0);l.responseType="arraybuffer";l.addEventListener("error",d);l.addEventListener("progress",function(a){if(a){var d=a.loaded,b=a.total;a.lengthComputable&&c({loaded:d,total:b})}});l.addEventListener("loadend",function(a){a&&(g=new Uint8Array(a.currentTarget.response),p=new window.Blob([g]),q.addEventListener("load",f,!1),q.src=h.createObjectURL(p))});l.send(null)}},N={load:function(a,
b,c,d){b=void 0===b?function(){}:b;var l=new e.Texture;ea.load(a,function(d){l.image=d;d=0<a.search(/\.(jpg|jpeg)$/)||0===a.search(/^data:image\/jpeg/);l.format=d?e.RGBFormat:e.RGBAFormat;l.needsUpdate=!0;b(l)},c,d);return l}},fa={load:function(a,b,c,d){b=void 0===b?function(){}:b;c=void 0===c?function(){}:c;var l;var g=new e.CubeTexture([]);var p=0;var m={};var k={};a.map(function(a,e){ea.load(a,function(a){g.images[e]=a;p++;6===p&&(g.needsUpdate=!0,b(g))},function(a){m[e]={loaded:a.loaded,total:a.total};
k.loaded=0;l=k.total=0;for(var d in m)l++,k.loaded+=m[d].loaded,k.total+=m[d].total;6>l&&(k.total=k.total/l*6);c(k)},d)});return g}};S.prototype=Object.assign(Object.create(e.EventDispatcher.prototype),{setContainer:function(a){this.container=a},setScene:function(a){this.scene=a},enumerateDevices:function(){var a=this.devices,b=new Promise(function(b){b(a)});return 0<a.length?b:window.navigator.mediaDevices.enumerateDevices()},switchNextVideoDevice:function(){var a=this.stop.bind(this),b=this.start.bind(this),
c=this.setVideDeviceIndex.bind(this),d=this.videoDeviceIndex;this.getDevices("video").then(function(l){a();d++;d>=l.length?(c(0),d--):c(d);b(l[d])})},getDevices:function(a){a=void 0===a?"video":a;var b=this.devices;return this.enumerateDevices().then(function(a){return a.map(function(a){b.includes(a)||b.push(a);return a})}).then(function(b){var d=new RegExp(a,"i");return b.filter(function(a){return d.test(a.kind)})})},getUserMedia:function(a){var b=this.setMediaStream.bind(this),c=this.playVideo.bind(this);
...
updateCanvasArcByProgress:function(a){var b=this.context,c=this.canvasWidth,d=this.canvasHeight,l=this.material,g=this.dpr,e=a*Math.PI*2,m=this.color.getStyle(),k=.5*c/g;g=.5*d/g;b.clearRect(0,0,c,d);b.beginPath();0===a?(b.arc(k,g,c/16,0,2*Math.PI),b.fillStyle=m,b.fill()):(b.arc(k,g,c/4-3,-Math.PI/2,-Math.PI/2+e),b.strokeStyle=m,b.lineWidth=3,b.stroke());b.closePath();l.map.needsUpdate=!0},ripple:function(){var a=this,b=this.context,c=this.canvasWidth,d=this.canvasHeight,l=this.material,g=this.rippleDuration,
e=performance.now(),m=this.color,k=this.dpr,h=.5*c/k,q=.5*d/k,f=function(){var p=window.requestAnimationFrame(f),v=(performance.now()-e)/g,n=0<1-v?1-v:0,r=v*c*.5/k;b.clearRect(0,0,c,d);b.beginPath();b.arc(h,q,r,0,2*Math.PI);b.fillStyle="rgba("+255*m.r+", "+255*m.g+", "+255*m.b+", "+n+")";b.fill();b.closePath();1<=v&&(window.cancelAnimationFrame(p),a.updateCanvasArcByProgress(0),a.dispatchEvent({type:"reticle-ripple-end"}));l.map.needsUpdate=!0};this.dispatchEvent({type:"reticle-ripple-start"});f()},
...
removeAll:function(){this._tweens={}},add:function(a){this._tweens[a.getId()]=a;this._tweensAddedDuringUpdate[a.getId()]=a},remove:function(a){delete this._tweens[a.getId()];delete this._tweensAddedDuringUpdate[a.getId()]},update:function(a,b){var d=Object.keys(this._tweens);if(0===d.length)return!1;for(a=void 0!==a?a:c.now();0<d.length;){this._tweensAddedDuringUpdate={};for(var l=0;l<d.length;l++){var e=this._tweens[d[l]];e&&!1===e.update(a)&&(e._isPlaying=!1,b||delete this._tweens[d[l]])}d=Object.keys(this._tweensAddedDuringUpdate)}return!0}};
...
var d=(a-this._startTime)/this._duration;d=0===this._duration||1<d?1:d;var c=this._easingFunction(d);for(b in this._valuesEnd)if(void 0!==this._valuesStart[b]){var e=this._valuesStart[b]||0,k=this._valuesEnd[b];k instanceof Array?this._object[b]=this._interpolationFunction(k,c):("string"===typeof k&&(k="+"===k.charAt(0)||"-"===k.charAt(0)?e+parseFloat(k):parseFloat(k)),"number"===typeof k&&(this._object[b]=e+(k-e)*c))}null!==this._onUpdateCallback&&this._onUpdateCallback(this._object,d);if(1===d)if(0<
...
1/2.75?7.5625*a*a:a<2/2.75?7.5625*(a-=1.5/2.75)*a+.75:a<2.5/2.75?7.5625*(a-=2.25/2.75)*a+.9375:7.5625*(a-=2.625/2.75)*a+.984375},InOut:function(a){return.5>a?.5*c.Easing.Bounce.In(2*a):.5*c.Easing.Bounce.Out(2*a-1)+.5}}};c.Interpolation={Linear:function(a,b){var d=a.length-1,l=d*b,e=Math.floor(l),k=c.Interpolation.Utils.Linear;return 0>b?k(a[0],a[1],l):1<b?k(a[d],a[d-1],d-l):k(a[e],a[e+1>d?d:e+1],l-e)},Bezier:function(a,b){for(var d=0,l=a.length-1,e=Math.pow,k=c.Interpolation.Utils.Bernstein,h=0;h<=
l;h++)d+=e(1-b,l-h)*e(b,h)*a[h]*k(l,h);return d},CatmullRom:function(a,b){var d=a.length-1,l=d*b,e=Math.floor(l),k=c.Interpolation.Utils.CatmullRom;return a[0]===a[d]?(0>b&&(e=Math.floor(l=d*(1+b))),k(a[(e-1+d)%d],a[e],a[(e+1)%d],a[(e+2)%d],l-e)):0>b?a[0]-(k(a[0],a[0],a[1],a[1],-l)-a[0]):1<b?a[d]-(k(a[d],a[d],a[d-1],a[d-1],l-d)-a[d]):k(a[e?e-1:0],a[e],a[d<e+1?d:e+1],a[d<e+2?d:e+2],l-e)},Utils:{Linear:function(a,b,c){return(b-a)*c+a},Bernstein:function(a,b){var d=c.Interpolation.Utils.Factorial;return d(a)/
...
onClick:function(a){if(this.element&&this.getContainer()){this.onHoverStart(a);if(this&&0<=a.mouseEvent.clientX&&0<=a.mouseEvent.clientY){a=this.left;var b=this.right,c=this.style;this.mode===t.CARDBOARD||this.mode===t.STEREO?(c.display="none",a.style.display="block",b.style.display="block",this._width=a.clientWidth,this._height=a.clientHeight):(c.display="block",a&&(a.style.display="none"),b&&(b.style.display="none"),this._width=this.clientWidth,this._height=this.clientHeight)}this.lockHoverElement()}},
onDismiss:function(){this.element&&(this.unlockHoverElement(),this.onHoverEnd())},onHover:function(){},onHoverStart:function(){if(this.getContainer()){var a=this.cursorStyle||(this.mode===t.NORMAL?"pointer":"default"),b=this.scaleDownAnimation,c=this.scaleUpAnimation;this.isHovering=!0;this.container.style.cursor=a;this.animated&&(b.stop(),c.start())}},onHoverEnd:function(){if(this.getContainer()){var a=this.scaleDownAnimation,b=this.scaleUpAnimation;this.isHovering=!1;this.container.style.cursor=
"default";this.animated&&(b.stop(),a.start())}},onDualEyeEffect:function(a){if(this.getContainer()){this.mode=a.mode;a=this.element;var b=this.container.clientWidth/2;var c=this.container.clientHeight/2;a&&(a.left||a.right||(a.left=a.cloneNode(!0),a.right=a.cloneNode(!0)),this.mode===t.CARDBOARD||this.mode===t.STEREO?(a.left.style.display=a.style.display,a.right.style.display=a.style.display,a.style.display="none"):(a.style.display=a.left.style.display,a.left.style.display="none",a.right.style.display=
"none"),this.translateElement(b,c),this.container.appendChild(a.left),this.container.appendChild(a.right))}},translateElement:function(a,b){if(this.element._width&&this.element._height&&this.getContainer()){var c=this.container;var d=this.element;var e=d._width/2;var g=d._height/2;var p=void 0!==d.verticalDelta?d.verticalDelta:40;var m=a-e;var k=b-g-p;this.mode!==t.CARDBOARD&&this.mode!==t.STEREO||!d.left||!d.right||a===c.clientWidth/2&&b===c.clientHeight/2?this.setElementStyle("transform",d,"translate("+
m+"px, "+k+"px)"):(m=c.clientWidth/4-e+(a-c.clientWidth/2),k=c.clientHeight/2-g-p+(b-c.clientHeight/2),this.setElementStyle("transform",d.left,"translate("+m+"px, "+k+"px)"),m+=c.clientWidth/2,this.setElementStyle("transform",d.right,"translate("+m+"px, "+k+"px)"))}},setElementStyle:function(a,b,c){b=b.style;"transform"===a&&(b.webkitTransform=b.msTransform=b.transform=c)},setText:function(a){this.element&&(this.element.textContent=a)},setCursorHoverStyle:function(a){this.cursorStyle=a},addHoverText:function(a,
b){b=void 0===b?40:b;this.element||(this.element=document.createElement("div"),this.element.style.display="none",this.element.style.color="#fff",this.element.style.top=0,this.element.style.maxWidth="50%",this.element.style.maxHeight="50%",this.element.style.textShadow="0 0 3px #000000",this.element.style.fontFamily='"Trebuchet MS", Helvetica, sans-serif',this.element.style.position="absolute",this.element.classList.add("panolens-infospot"),this.element.verticalDelta=b);this.setText(a)},addHoverElement:function(a,
...
this.element=null)},lockHoverElement:function(){this.element&&(this.element.locked=!0)},unlockHoverElement:function(){this.element&&(this.element.locked=!1)},enableRaycast:function(a){this.raycast=void 0===a||a?this.originalRaycast:function(){}},show:function(a){a=void 0===a?0:a;var b=this.hideAnimation,c=this.showAnimation,d=this.material;this.animated?(b.stop(),c.delay(a).start()):(this.enableRaycast(!0),d.opacity=1)},hide:function(a){a=void 0===a?0:a;var b=this.animated,c=this.hideAnimation,d=
this.showAnimation,e=this.material,g=this.element;g&&(g.style.display="none");b?(d.stop(),c.delay(a).start()):(this.enableRaycast(!1),e.opacity=0)},setFocusMethod:function(a){a&&(this.HANDLER_FOCUS=a.method)},focus:function(a,b){this.HANDLER_FOCUS&&(this.HANDLER_FOCUS(this.position,a,b),this.onDismiss())},dispose:function(){var a=this.geometry,b=this.material,c=b.map;this.removeHoverElement();this.parent&&this.parent.remove(this);c&&(c.dispose(),b.map=null);a&&(a.dispose(),this.geometry=null);b&&
(b.dispose(),this.material=null)}});I.prototype=Object.assign(Object.create(e.EventDispatcher.prototype),{constructor:I,addControlBar:function(){if(this.container){var a=this,b,c;var d=document.createElement("div");d.style.width="100%";d.style.height="44px";d.style.float="left";d.style.transform=d.style.webkitTransform=d.style.msTransform="translateY(-100%)";d.style.background="-webkit-linear-gradient(bottom, rgba(0,0,0,0.2), rgba(0,0,0,0))";d.style.background="-moz-linear-gradient(bottom, rgba(0,0,0,0.2), rgba(0,0,0,0))";
d.style.background="-o-linear-gradient(bottom, rgba(0,0,0,0.2), rgba(0,0,0,0))";d.style.background="-ms-linear-gradient(bottom, rgba(0,0,0,0.2), rgba(0,0,0,0))";d.style.background="linear-gradient(bottom, rgba(0,0,0,0.2), rgba(0,0,0,0))";d.style.transition=this.DEFAULT_TRANSITION;d.style.pointerEvents="none";d.isHidden=!1;d.toggle=function(){d.isHidden=!d.isHidden;b=d.isHidden?"translateY(0)":"translateY(-100%)";c=d.isHidden?0:1;d.style.transform=d.style.webkitTransform=d.style.msTransform=b;d.style.opacity=
c};var e=this.createDefaultMenu();this.mainMenu=this.createMainMenu(e);d.appendChild(this.mainMenu);this.mask=e=this.createMask();this.container.appendChild(e);d.dispose=function(){a.fullscreenElement&&(d.removeChild(a.fullscreenElement),a.fullscreenElement.dispose(),a.fullscreenElement=null);a.settingElement&&(d.removeChild(a.settingElement),a.settingElement.dispose(),a.settingElement=null);a.videoElement&&(d.removeChild(a.videoElement),a.videoElement.dispose(),a.videoElement=null)};this.container.appendChild(d);
this.mask.addEventListener("mousemove",this.PREVENT_EVENT_HANDLER,!0);this.mask.addEventListener("mouseup",this.PREVENT_EVENT_HANDLER,!0);this.mask.addEventListener("mousedown",this.PREVENT_EVENT_HANDLER,!0);this.mask.addEventListener(a.TOUCH_ENABLED?"touchend":"click",function(b){b.preventDefault();b.stopPropagation();a.mask.hide();a.settingElement.deactivate()},!1);this.addEventListener("control-bar-toggle",d.toggle);this.barElement=d}else console.warn("Widget container not set")},createDefaultMenu:function(){var a=
this;var b=function(b,d){return function(){a.dispatchEvent({type:"panolens-viewer-handler",method:b,data:d})}};return[{title:"Control",subMenu:[{title:this.TOUCH_ENABLED?"Touch":"Mouse",handler:b("enableControl",E.ORBIT)},{title:"Sensor",handler:b("enableControl",E.DEVICEORIENTATION)}]},{title:"Mode",subMenu:[{title:"Normal",handler:b("disableEffect")},{title:"Cardboard",handler:b("enableEffect",t.CARDBOARD)},{title:"Stereoscopic",handler:b("enableEffect",t.STEREO)}]}]},addControlButton:function(a){switch(a){case "fullscreen":this.fullscreenElement=
a=this.createFullscreenButton();break;case "setting":this.settingElement=a=this.createSettingButton();break;case "video":this.videoElement=a=this.createVideoControl();break;default:return}a&&this.barElement.appendChild(a)},createMask:function(){var a=document.createElement("div");a.style.position="absolute";a.style.top=0;a.style.left=0;a.style.width="100%";a.style.height="100%";a.style.background="transparent";a.style.display="none";a.show=function(){this.style.display="block"};a.hide=function(){this.style.display=
"none"};return a},createSettingButton:function(){var a=this;var b=this.createCustomItem({style:{backgroundImage:'url("'+u.Setting+'")',webkitTransition:this.DEFAULT_TRANSITION,transition:this.DEFAULT_TRANSITION},onTap:function(b){b.preventDefault();b.stopPropagation();a.mainMenu.toggle();this.activated?this.deactivate():this.activate()}});b.activate=function(){this.style.transform="rotate3d(0,0,1,90deg)";this.activated=!0;a.mask.show()};b.deactivate=function(){this.style.transform="rotate3d(0,0,0,0)";
this.activated=!1;a.mask.hide();a.mainMenu&&a.mainMenu.visible&&a.mainMenu.hide();a.activeSubMenu&&a.activeSubMenu.visible&&a.activeSubMenu.hide();a.mainMenu&&a.mainMenu._width&&(a.mainMenu.changeSize(a.mainMenu._width),a.mainMenu.unslideAll())};b.activated=!1;return b},createFullscreenButton:function(){function a(){d&&(c=!c,g.style.backgroundImage=c?'url("'+u.FullscreenLeave+'")':'url("'+u.FullscreenEnter+'")');b.dispatchEvent({type:"panolens-viewer-handler",method:"onWindowResize"});d=!0}var b=
this,c=!1,d=!0,e=this.container;if(document.fullscreenEnabled||document.webkitFullscreenEnabled||document.mozFullScreenEnabled||document.msFullscreenEnabled){document.addEventListener("fullscreenchange",a,!1);document.addEventListener("webkitfullscreenchange",a,!1);document.addEventListener("mozfullscreenchange",a,!1);document.addEventListener("MSFullscreenChange",a,!1);var g=this.createCustomItem({style:{backgroundImage:'url("'+u.FullscreenEnter+'")'},onTap:function(a){a.preventDefault();a.stopPropagation();
d=!1;c?(document.exitFullscreen&&document.exitFullscreen(),document.msExitFullscreen&&document.msExitFullscreen(),document.mozCancelFullScreen&&document.mozCancelFullScreen(),document.webkitExitFullscreen&&document.webkitExitFullscreen(),c=!1):(e.requestFullscreen&&e.requestFullscreen(),e.msRequestFullscreen&&e.msRequestFullscreen(),e.mozRequestFullScreen&&e.mozRequestFullScreen(),e.webkitRequestFullscreen&&e.webkitRequestFullscreen(Element.ALLOW_KEYBOARD_INPUT),c=!0);this.style.backgroundImage=c?
'url("'+u.FullscreenLeave+'")':'url("'+u.FullscreenEnter+'")'}});if(!document.querySelector("panolens-style-addon")){var p=document.createElement("style");p.id="panolens-style-addon";p.innerHTML=":-webkit-full-screen { width: 100% !important; height: 100% !important }";document.body.appendChild(p)}return g}},createVideoControl:function(){var a=document.createElement("span");a.style.display="none";a.show=function(){a.style.display=""};a.hide=function(){a.style.display="none";a.controlButton.paused=
!0;a.controlButton.update()};a.controlButton=this.createVideoControlButton();a.seekBar=this.createVideoControlSeekbar();a.appendChild(a.controlButton);a.appendChild(a.seekBar);a.dispose=function(){a.removeChild(a.controlButton);a.removeChild(a.seekBar);a.controlButton.dispose();a.controlButton=null;a.seekBar.dispose();a.seekBar=null};this.addEventListener("video-control-show",a.show);this.addEventListener("video-control-hide",a.hide);return a},createVideoControlButton:function(){var a=this,b=this.createCustomItem({style:{float:"left",
backgroundImage:'url("'+u.VideoPlay+'")'},onTap:function(c){c.preventDefault();c.stopPropagation();a.dispatchEvent({type:"panolens-viewer-handler",method:"toggleVideoPlay",data:!this.paused});this.paused=!this.paused;b.update()}});b.paused=!0;b.update=function(a){this.paused=void 0!==a?a:this.paused;this.style.backgroundImage='url("'+(this.paused?u.VideoPlay:u.VideoPause)+'")'};return b},createVideoControlSeekbar:function(){function a(a){a.stopPropagation();g=!0;p=a.clientX||a.changedTouches&&a.changedTouches[0].clientX;
m=parseInt(h.style.width)/100;e.container.addEventListener("mousemove",b,{passive:!0});e.container.addEventListener("mouseup",c,{passive:!0});e.container.addEventListener("touchmove",b,{passive:!0});e.container.addEventListener("touchend",c,{passive:!0})}function b(a){g&&(k=((a.clientX||a.changedTouches&&a.changedTouches[0].clientX)-p)/f.clientWidth,k=m+k,k=1<k?1:0>k?0:k,f.setProgress(k),e.dispatchEvent({type:"panolens-viewer-handler",method:"setVideoCurrentTime",data:k}))}function c(a){a.stopPropagation();
g=!1;d()}function d(){e.container.removeEventListener("mousemove",b,!1);e.container.removeEventListener("mouseup",c,!1);e.container.removeEventListener("touchmove",b,!1);e.container.removeEventListener("touchend",c,!1)}var e=this,g=!1,p,m,k;var h=document.createElement("div");h.style.width="0%";h.style.height="100%";h.style.backgroundColor="#fff";var q=document.createElement("div");q.style.float="right";q.style.width="14px";q.style.height="14px";q.style.transform="translate(7px, -5px)";q.style.borderRadius=
"50%";q.style.backgroundColor="#ddd";q.addEventListener("mousedown",a,{passive:!0});q.addEventListener("touchstart",a,{passive:!0});h.appendChild(q);var f=this.createCustomItem({style:{float:"left",width:"30%",height:"4px",marginTop:"20px",backgroundColor:"rgba(188,188,188,0.8)"},onTap:function(a){a.preventDefault();a.stopPropagation();if(a.target!==q){var b=a.changedTouches&&0<a.changedTouches.length?(a.changedTouches[0].pageX-a.target.getBoundingClientRect().left)/this.clientWidth:a.offsetX/this.clientWidth;
e.dispatchEvent({type:"panolens-viewer-handler",method:"setVideoCurrentTime",data:b});f.setProgress(a.offsetX/this.clientWidth)}},onDispose:function(){d();q=h=null}});f.appendChild(h);f.setProgress=function(a){h.style.width=100*a+"%"};this.addEventListener("video-update",function(a){f.setProgress(a.percentage)});f.progressElement=h;f.progressElementControl=q;return f},createMenuItem:function(a){var b=this,c=document.createElement("a");c.textContent=a;c.style.display="block";c.style.padding="10px";
c.style.textDecoration="none";c.style.cursor="pointer";c.style.pointerEvents="auto";c.style.transition=this.DEFAULT_TRANSITION;c.slide=function(a){this.style.transform="translateX("+(a?"":"-")+"100%)"};c.unslide=function(){this.style.transform="translateX(0)"};c.setIcon=function(a){this.icon&&(this.icon.style.backgroundImage="url("+a+")")};c.setSelectionTitle=function(a){this.selection&&(this.selection.textContent=a)};c.addSelection=function(a){var b=document.createElement("span");b.style.fontSize=
"13px";b.style.fontWeight="300";b.style.float="right";this.selection=b;this.setSelectionTitle(a);this.appendChild(b);return this};c.addIcon=function(a,b,c){a=void 0===a?u.ChevronRight:a;b=void 0===b?!1:b;c=void 0===c?!1:c;var d=document.createElement("span");d.style.float=b?"left":"right";d.style.width="17px";d.style.height="17px";d.style["margin"+(b?"Right":"Left")]="12px";d.style.backgroundSize="cover";c&&(d.style.transform="rotateZ(180deg)");this.icon=d;this.setIcon(a);this.appendChild(d);return this};
c.addSubMenu=function(a,c){this.subMenu=b.createSubMenu(a,c);return this};c.addEventListener("mouseenter",function(){this.style.backgroundColor="#e0e0e0"},!1);c.addEventListener("mouseleave",function(){this.style.backgroundColor="#fafafa"},!1);return c},createMenuItemHeader:function(a){a=this.createMenuItem(a);a.style.borderBottom="1px solid #333";a.style.paddingBottom="15px";return a},createMainMenu:function(a){function b(a){a.preventDefault();a.stopPropagation();var b=c.mainMenu,d=this.subMenu;
b.hide();b.slideAll();b.parentElement.appendChild(d);c.activeMainItem=this;c.activeSubMenu=d;window.requestAnimationFrame(function(){b.changeSize(d.clientWidth);d.show();d.unslideAll()})}var c=this,d=this.createMenu();d._width=200;d.changeSize(d._width);for(var e=0;e<a.length;e++){var g=d.addItem(a[e].title);g.style.paddingLeft="20px";g.addIcon().addEventListener(c.TOUCH_ENABLED?"touchend":"click",b,!1);a[e].subMenu&&0<a[e].subMenu.length&&g.addSelection(a[e].subMenu[0].title).addSubMenu(a[e].title,
a[e].subMenu)}return d},createSubMenu:function(a,b){function c(a){a.preventDefault();a.stopPropagation();e=d.mainMenu;e.changeSize(e._width);e.unslideAll();e.show();g.slideAll(!0);g.hide();"header"!==this.type&&(g.setActiveItem(this),d.activeMainItem.setSelectionTitle(this.textContent),this.handler&&this.handler())}var d=this,e,g=this.createMenu();g.items=b;g.activeItem=null;g.addHeader(a).addIcon(void 0,!0,!0).addEventListener(d.TOUCH_ENABLED?"touchend":"click",c,!1);for(a=0;a<b.length;a++){var h=
g.addItem(b[a].title);h.style.fontWeight=300;h.handler=b[a].handler;h.addIcon(" ",!0);h.addEventListener(d.TOUCH_ENABLED?"touchend":"click",c,!1);g.activeItem||g.setActiveItem(h)}g.slideAll(!0);return g},createMenu:function(){var a=this,b=document.createElement("span"),c=b.style;c.padding="5px 0";c.position="fixed";c.bottom="100%";c.right="14px";c.backgroundColor="#fafafa";c.fontFamily="Helvetica Neue";c.fontSize="14px";c.visibility="hidden";c.opacity=0;c.boxShadow="0 0 12pt rgba(0,0,0,0.25)";c.borderRadius=
...
b.geometry,d=b.material,e=b.children.length-1;0<=e;e--)a(b.children[e]),b.remove(b.children[e]);b instanceof z&&b.dispose();c&&(c.dispose(),b.geometry=null);d&&(d.dispose(),b.material=null)}this.infospotAnimation.stop();this.fadeInAnimation.stop();this.fadeOutAnimation.stop();this.enterTransition.stop();this.leaveTransition.stop();this.dispatchEvent({type:"panolens-viewer-handler",method:"onPanoramaDispose",data:this});a(this);this.parent&&this.parent.remove(this)}});y.prototype=Object.assign(Object.create(n.prototype),
{constructor:y,load:function(a){a=a||this.src;if(!a)console.warn("Image source undefined");else if("string"===typeof a)N.load(a,this.onLoad.bind(this),this.onProgress.bind(this),this.onError.bind(this));else if(a instanceof HTMLImageElement)this.onLoad(new e.Texture(a))},onLoad:function(a){a.minFilter=a.magFilter=e.LinearFilter;a.needsUpdate=!0;this.updateTexture(a);window.requestAnimationFrame(n.prototype.onLoad.bind(this))},reset:function(){n.prototype.reset.call(this)},dispose:function(){var a=
...
4)))a=!0;return a},load:function(){var a=this.options,b=a.muted,c=a.loop,d=a.autoplay,e=a.playsinline;a=a.crossOrigin;var g=this.videoElement,h=this.material,m=this.onProgress.bind(this),k=this.onLoad.bind(this);g.loop=c;g.autoplay=d;g.playsinline=e;g.crossOrigin=a;g.muted=b;e&&(g.setAttribute("playsinline",""),g.setAttribute("webkit-playsinline",""));e=function(){this.setVideoTexture(g);d&&this.dispatchEvent({type:"panolens-viewer-handler",method:"updateVideoPlayButton",data:!1});this.isMobile()&&
(g.pause(),d&&b?this.dispatchEvent({type:"panolens-viewer-handler",method:"updateVideoPlayButton",data:!1}):this.dispatchEvent({type:"panolens-viewer-handler",method:"updateVideoPlayButton",data:!0}));window.requestAnimationFrame(function(){h.map.needsUpdate=!0;m({loaded:1,total:1});k()})};2<g.readyState?e.call(this):(0===g.querySelectorAll("source").length&&(a=document.createElement("source"),a.src=this.src,g.appendChild(a)),g.load());g.addEventListener("loadeddata",e.bind(this));g.addEventListener("timeupdate",
function(){this.videoProgress=0<=g.duration?g.currentTime/g.duration:0;this.dispatchEvent({type:"panolens-viewer-handler",method:"onVideoUpdate",data:this.videoProgress})}.bind(this));g.addEventListener("ended",function(){c||(this.resetVideo(),this.dispatchEvent({type:"panolens-viewer-handler",method:"updateVideoPlayButton",data:!0}))}.bind(this),!1)},setVideoTexture:function(a){a&&(a=new e.VideoTexture(a),a.minFilter=e.LinearFilter,a.magFilter=e.LinearFilter,a.format=e.RGBFormat,this.updateTexture(a))},
...
reverseDraggingDirection:function(){this.OrbitControls.rotateSpeed*=-1;this.OrbitControls.momentumScalingFactor*=-1},addReticle:function(){this.reticle=new M(16777215,!0,this.options.dwellTime);this.reticle.hide();this.camera.add(this.reticle);this.sceneReticle.add(this.camera)},tweenControlCenter:function(a,b,c){var d;if(this.control===this.OrbitControls){a instanceof Array&&(b=a[1],c=a[2],a=a[0]);b=void 0!==b?b:1E3;c=c||r.Easing.Exponential.Out;var l=this;var g=this.camera.getWorldDirection(new e.Vector3);
var h=g.clone();var m=this.panorama.getWorldPosition(new e.Vector3).sub(this.camera.getWorldPosition(new e.Vector3));a=a.clone();a.x*=-1;a.add(m).normalize();var k=a.clone();g.y=0;a.y=0;m=Math.atan2(a.z,a.x)-Math.atan2(g.z,g.x);m=m>Math.PI?m-2*Math.PI:m;m=m<-Math.PI?m+2*Math.PI:m;g=Math.abs(h.angleTo(g)+(0>=h.y*k.y?k.angleTo(a):-k.angleTo(a)));g*=k.y<h.y?1:-1;h={left:0,up:0};var n=d=0;this.tweenLeftAnimation.stop();this.tweenUpAnimation.stop();this.tweenLeftAnimation=(new r.Tween(h)).to({left:m},
b).easing(c).onUpdate(function(a){l.control.rotateLeft(a.left-d);d=a.left}).start();this.tweenUpAnimation=(new r.Tween(h)).to({up:g},b).easing(c).onUpdate(function(a){l.control.rotateUp(a.up-n);n=a.up}).start()}},tweenControlCenterByObject:function(a,b,c){var d=!1;a.traverseAncestors(function(a){a.scalePlaceHolder&&(d=!0)});if(d){var l=new e.Vector3(-1,1,1);this.tweenControlCenter(a.getWorldPosition(new e.Vector3).multiply(l),b,c)}else this.tweenControlCenter(a.getWorldPosition(new e.Vector3),b,c)},
...
document.createElement("div");a.style.position="absolute";a.style.right="10px";a.style.top="10px";a.style.color="#fff";this.container.appendChild(a);this.outputDivElement=a},outputPosition:function(){var a=this.raycaster.intersectObject(this.panorama,!0);if(0<a.length){a=a[0].point.clone();var b=new e.Vector3(-1,1,1),c=this.panorama.getWorldPosition(new e.Vector3);a.sub(c).multiply(b);b={x:a.x.toFixed(2),y:a.y.toFixed(2),z:a.z.toFixed(2)};c=b.x+", "+b.y+", "+b.z;if(0!==a.length())switch(this.options.output){case "event":this.dispatchEvent({type:"position-output",
position:b});break;case "console":console.info(c);document.cookie="Cords="+c+";";break;case "overlay":this.outputDivElement.textContent=c}}},onMouseDown:function(a){a.preventDefault();this.userMouse.x=0<=a.clientX?a.clientX:a.touches[0].clientX;this.userMouse.y=0<=a.clientY?a.clientY:a.touches[0].clientY;this.userMouse.type="mousedown";this.onTap(a)},onMouseMove:function(a){a.preventDefault();this.userMouse.type="mousemove";this.onTap(a)},onMouseUp:function(a){this.userMouse.type="mouseup";var b=
this.userMouse.x>=a.clientX-this.options.clickTolerance&&this.userMouse.x<=a.clientX+this.options.clickTolerance&&this.userMouse.y>=a.clientY-this.options.clickTolerance&&this.userMouse.y<=a.clientY+this.options.clickTolerance||a.changedTouches&&this.userMouse.x>=a.changedTouches[0].clientX-this.options.clickTolerance&&this.userMouse.x<=a.changedTouches[0].clientX+this.options.clickTolerance&&this.userMouse.y>=a.changedTouches[0].clientY-this.options.clickTolerance&&this.userMouse.y<=a.changedTouches[0].clientY+
...
this.options.autoRotateActivationDuration)))}},getConvertedIntersect:function(a){for(var b,c=0;c<a.length;c++)if(0<=a[c].distance&&a[c].object&&!a[c].object.passThrough&&(!a[c].object.entity||!a[c].object.entity.passThrough)){b=a[c].object.entity&&!a[c].object.entity.passThrough?a[c].object.entity:a[c].object;break}return b},hideInfospot:function(){this.infospot&&(this.infospot.onHoverEnd(),this.infospot=void 0)},toggleControlBar:function(){var a=this.widget;a&&a.dispatchEvent({type:"control-bar-toggle"})},
onKeyDown:function(a){this.options.output&&"none"!==this.options.output&&"Control"===a.key&&(this.OUTPUT_INFOSPOT=!0)},onKeyUp:function(){this.OUTPUT_INFOSPOT=!1},update:function(){r.update();this.updateCallbacks.forEach(function(a){a()});this.control.update();this.scene.traverse(function(a){if(a instanceof z&&a.element&&(this.hoverObject===a||"none"!==a.element.style.display||a.element.left&&"none"!==a.element.left.style.display||a.element.right&&"none"!==a.element.right.style.display))if(this.checkSpriteInViewport(a)){var b=
this.getScreenVector(a.getWorldPosition(new e.Vector3));a.translateElement(b.x,b.y)}else a.onDismiss()}.bind(this))},render:function(){this.mode===t.CARDBOARD||this.mode===t.STEREO?(this.renderer.clear(),this.effect.render(this.scene,this.camera),this.effect.render(this.sceneReticle,this.camera)):(this.renderer.clear(),this.renderer.render(this.scene,this.camera),this.renderer.clearDepth(),this.renderer.render(this.sceneReticle,this.camera))},animate:function(){this.requestAnimationId=window.requestAnimationFrame(this.animate.bind(this));
...
this.HANDLER_MOUSE_DOWN,!1);this.container.removeEventListener("mousemove",this.HANDLER_MOUSE_MOVE,!1);this.container.removeEventListener("mouseup",this.HANDLER_MOUSE_UP,!1);this.container.removeEventListener("touchstart",this.HANDLER_MOUSE_DOWN,!1);this.container.removeEventListener("touchend",this.HANDLER_MOUSE_UP,!1)},registerReticleEvent:function(){this.addUpdateCallback(this.HANDLER_TAP)},unregisterReticleEvent:function(){this.removeUpdateCallback(this.HANDLER_TAP)},updateReticleEvent:function(){var a=
this.container.clientWidth/2+this.container.offsetLeft,b=this.container.clientHeight/2;this.removeUpdateCallback(this.HANDLER_TAP);this.HANDLER_TAP=this.onTap.bind(this,{clientX:a,clientY:b});this.addUpdateCallback(this.HANDLER_TAP)},registerEventListeners:function(){window.addEventListener("resize",this.HANDLER_WINDOW_RESIZE,!0);window.addEventListener("keydown",this.HANDLER_KEY_DOWN,!0);window.addEventListener("keyup",this.HANDLER_KEY_UP,!0)},unregisterEventListeners:function(){window.removeEventListener("resize",
this.HANDLER_WINDOW_RESIZE,!0);window.removeEventListener("keydown",this.HANDLER_KEY_DOWN,!0);window.removeEventListener("keyup",this.HANDLER_KEY_UP,!0)},dispose:function(){function a(b){for(var c=b.children.length-1;0<=c;c--)a(b.children[c]),b.remove(b.children[c]);b instanceof n||b instanceof z?b.dispose():b.dispatchEvent&&b.dispatchEvent("dispose")}this.tweenLeftAnimation.stop();this.tweenUpAnimation.stop();this.unregisterEventListeners();a(this.scene);this.widget&&(this.widget.dispose(),this.widget=
null);e.Cache&&e.Cache.enabled&&e.Cache.clear()},destroy:function(){this.dispose();this.render();window.cancelAnimationFrame(this.requestAnimationId)},onPanoramaDispose:function(a){a instanceof B&&this.hideVideoWidget();a===this.panorama&&(this.panorama=null)},loadAsyncRequest:function(a,b){b=void 0===b?function(){}:b;var c=new window.XMLHttpRequest;c.onloadend=function(a){b(a)};c.open("GET",a,!0);c.send(null)},addViewIndicator:function(){var a=this;this.loadAsyncRequest(u.ViewIndicator,function(b){if(0!==
b.loaded){b=b.target.responseXML.documentElement;b.style.width=a.viewIndicatorSize+"px";b.style.height=a.viewIndicatorSize+"px";b.style.position="absolute";b.style.top="10px";b.style.left="10px";b.style.opacity="0.5";b.style.cursor="pointer";b.id="panolens-view-indicator-container";a.container.appendChild(b);var c=b.querySelector("#indicator");a.addUpdateCallback(function(){a.radius=.225*a.viewIndicatorSize;a.currentPanoAngle=a.camera.rotation.y-e.Math.degToRad(90);a.fovAngle=e.Math.degToRad(a.camera.fov);
