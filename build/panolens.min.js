...
onClick:function(a){if(this.element&&this.getContainer()){this.getContainer().getElementsByClassName().style.display="none";this.onHoverStart(a);var b=this.element;if(b&&0<=a.mouseEvent.clientX&&0<=a.mouseEvent.clientY){a=b.left;var c=b.right,d=b.style;this.mode===t.CARDBOARD||this.mode===t.STEREO?(d.display="none",a.style.display="block",c.style.display="block",b._width=a.clientWidth,b._height=a.clientHeight):(d.display="block",a&&(a.style.display="none"),c&&(c.style.display="none"),b._width=b.clientWidth,
...
this.mode===t.STEREO?(a.left.style.display=a.style.display,a.right.style.display=a.style.display,a.style.display="none"):(a.style.display=a.left.style.display,a.left.style.display="none",a.right.style.display="none"),this.translateElement(b,c),this.container.appendChild(a.left),this.container.appendChild(a.right))}},translateElement:function(a,b){if(this.element._width&&this.element._height&&this.getContainer()){var c=this.container;var d=this.element;var e=d._width/2;var g=d._height/2;var p=void 0!==
d.verticalDelta?d.verticalDelta:40;var m=a-e;var k=b-g-p;this.mode!==t.CARDBOARD&&this.mode!==t.STEREO||!d.left||!d.right||a===c.clientWidth/2&&b===c.clientHeight/2?this.setElementStyle("transform",d,"translate("+m+"px, "+k+"px)"):(m=c.clientWidth/4-e+(a-c.clientWidth/2),k=c.clientHeight/2-g-p+(b-c.clientHeight/2),this.setElementStyle("transform",d.left,"translate("+m+"px, "+k+"px)"),m+=c.clientWidth/2,this.setElementStyle("transform",d.right,"translate("+m+"px, "+k+"px)"))}},setElementStyle:function(a,
